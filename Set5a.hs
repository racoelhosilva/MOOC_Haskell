...
rgb Green = [0,1,0]
rgb Blue = [0,0,1]
rgb (Mix c1 c2) = zipWith (\c1 c2 -> (c1+c2)/2) (rgb c1) (rgb c2)
...
prettyPrint End = ""
prettyPrint (O r) = prettyPrint r ++ "0"
prettyPrint (I r) = prettyPrint r ++ "1"

fromBin :: Bin -> Int
fromBin End = 0
fromBin (O r) = (fromBin r) * 2
fromBin (I r) = (fromBin r) * 2 + 1
